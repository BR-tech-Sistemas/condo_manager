<x-guest-layout>
    ...
    <nav class="navbar fixed-top">
        <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
            ...
            <a class="text-gray-800 font-semibold text-3xl leading-4 no-underline page-scroll" href="{{ route('welcome') }}">Gerenciador Condomínio</a>
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center"
                ...
                <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    ...
                    <li>
                        <a class="nav-link page-scroll" href="{{ route('filament.app.auth.login') }}">Login</a>
                    </li>
                </ul>
    ...
    <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                <h1 class="h1-large mb-5">Gerenciador de Condomínios</h1>
                <p class="p-large mb-8">
                    A maneira mais fácil, prática, segura e rápida de gerenciar todos os aspectos do seu condomínio
                </p>
                <a class="btn-solid-lg" href="#pricing"><i class="fas fa-tags"></i> Veja nossos planos</a>
            </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="italic mb-3">It's been so fun to work with Pavo, I've managed to integrate
    ...
    <div class="footer">
        <div class="container px-4 sm:px-8">
            <h4 class="mb-8 lg:max-w-3xl lg:mx-auto">Pavo is a mobile application for marketing automation and you can
                reach the team at <a class="text-indigo-600 hover:text-gray-500" href="mailto:email@domain.com">email@domain.com</a>
            </h4>
    ...
    <div class="copyright">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-3">
            ...
            <p class="pb-2 p-small statement">Distributed by :<a href="https://themewagon.com/" class="no-underline">Themewagon</a>
            </p>
        </div>
